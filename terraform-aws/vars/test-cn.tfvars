...
private_subnets_cidrs = ["10.60.0.0/20", "10.60.16.0/20"]
public_subnets_cidrs  = ["10.60.48.0/22", "10.60.52.0/22"]
...
spot_worker_instance_type            = "m5.2xlarge"
worker_instance_types                = "m5.2xlarge,m5d.2xlarge,m5a.2xlarge"
spot_worker_enable_asg_metrics       = "yes"
spot_worker_restrict_metadata_access = "yes"

eks_version                        = "1.25" # upgrade controlplane first then update eks_version_latest_ami to the same version
eks_version_latest_ami             = "1.25"
